...
from HPOBenchExperimentUtils.analysis.stats_generation import plot_fidels, plot_overhead, plot_ecdf
...
if __name__ == "__main__":
    ...
    parser.add_argument('--what', choices=["all", "table", "over_time", "other", "ecdf"], default="all")
