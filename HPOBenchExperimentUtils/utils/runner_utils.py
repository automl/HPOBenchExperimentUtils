...
def load_benchmark_settings() -> Dict:
    """ Load the experiment settings from file """
    experiment_settings_path = Path(__file__).absolute().parent.parent.glob("*benchmark_settings.yaml")  # / 'benchmark_settings.yaml'

    experiment_settings = dict()
    for yaml_file in experiment_settings:
